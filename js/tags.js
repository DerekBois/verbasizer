...
export const tags = [
  ...
  [
    ...
    `won't you tell ^g4> how long`,
    `will ^g1 have to wait`,
    `can ^g1 get away now`,
    `come hear mama`,
    `can ^g1 get you now`,
    `let you treat me like a dog`,
    `payin' a rose on me`,
  ...
  [
    ...
    `asked ^g2o once`,
    `asked ^g2o twice`,
    `asked ^g2o three times o'er`,
    `called ^g2o by her name again`,
    `took ^g2o hand in his`,
    ...
    `carried ^g4 away`,
    `brought ^g4 here`,
    `^g1o threw ^g2 hat out the window`,
    `will get another mama`,
    `they throwed ^g4 in the jail`,
    `payin' a rose on ^g4`,
    `can ease your pain`,
